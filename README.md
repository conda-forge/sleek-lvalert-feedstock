About sleek-lvalert-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sleek-lvalert-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6128&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sleek-lvalert-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sleek-lvalert` can be installed with `conda`:
...
```
mamba install sleek-lvalert
```

It is possible to list all of the versions of `sleek-lvalert` available on your platform with `conda`:
...
```
mamba search sleek-lvalert --channel conda-forge
```
...
mamba repoquery search sleek-lvalert --channel conda-forge

# List packages depending on `sleek-lvalert`:
mamba repoquery whoneeds sleek-lvalert --channel conda-forge

# List dependencies of `sleek-lvalert`:
mamba repoquery depends sleek-lvalert --channel conda-forge
```
